...
| D12 | Docker Compose is the primary runtime; **K8s StatefulSet + kind** included | K8s-only (heavier to stand up locally) | StatefulSet gives stable identities (`raftkv-0.raftkv-hl`) that consensus peers need | High |
