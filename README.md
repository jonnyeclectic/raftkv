...
| Performance regressions | `tests/test_log_repair.py` | Costs that were measured rather than guessed, each pinned so it cannot come back: starting with one-index backtracking |
